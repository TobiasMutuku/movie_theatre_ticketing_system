...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><b>OM</b>TS</span>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
		 ...
		 <li class="treeview">
          <a href="users.php">
            <i class="fa fa-plus"></i> <span>Members</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li class="treeview">
          <a href="view_bookings.php">
            <i class="fa fa-plus"></i> <span>Bookings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li class="treeview">
          <a href="report.php">
            <i class="fa fa-plus"></i> <span> Bookings Reports</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <a href="cancelled_bookings.php">
            <i class="fa fa-plus"></i> <span>Cancelled Bookings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		...
		<li class="treeview">
          <a href="cancel_report.php">
            <i class="fa fa-plus"></i> <span>Cancelled Bookings Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="logout.php">
            <i class="fa fa-plus"></i> <span>Logout</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
