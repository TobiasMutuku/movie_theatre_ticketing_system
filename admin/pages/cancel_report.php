...
<script type="text/javascript" src="../../validation/dist/js/bootstrapValidator.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="report.php"><i class="fa fa-home"></i> Home</a></li>
      ...
      <div class="box">
        <div class="box-body">
            ...
            <div class="box-header">
			  ...
			  <form method="post" action="reportcheck.php">
  <label for="booking_date">Enter a date:</label>
  <input type="date" id="booking_date" name="booking_date">
  <input type="submit" value="Check Reports">
</form>
            <!-- /.box-header -->
					<?php
						...
						while($bkg=mysqli_fetch_array($bk))
						{
							...
							<tr>
								...
								<td>
								 ...
								 <td>
               <a href="invoice_cancel.php?print=<?php echo $bkg['ticket_id']; ?>" class="btn"> <i class="fas fa-trash"></i> print </a>
            </td>
							<?php
						}
				}
