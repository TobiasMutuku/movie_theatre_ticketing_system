...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 if(mysqli_num_rows($select)){
       ...
       echo"<h2>Bookings on $booking_date:</h2>";
 }
	   ?>
    <div class="box-body no-padding">
     <table class="table table-condensed">
    <tr><th>Ticket Number</th><th>User</th><th>Movie</th><th>Theatre</th><th>Screen</th><th>Show</th><th>Seats</th><th>Amount</th><th>Ticket date</th></tr>
