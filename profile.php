		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						...
						<?php
				$bk=mysqli_query($con,"select * from tbl_bookings where user_id = $user_id AND status='1'");
					...
					<table class="table table-bordered">
						...
						while($bkg=mysqli_fetch_array($bk))
						{
							...
							<tr>
								...
								<td>
               <a href="invoice.php?print=<?php echo $bkg['ticket_id']; ?>" class="btn"> <i class="fas fa-trash"></i> print </a>
            </td>
							</tr>
							<?php
						}
				...
				?>
				<div class="about span_1_of_2">	
						<a href="canceled.php">View your canceled bookings</a>
					</div>		
					</div>
