									...
									<tr>
										...
										<td>
											<?php 
												...
												$s=mysqli_query($con,"select  * from tbl_screens where screen_id='".$ttme['screen_id']."'");
												
												$srn=mysqli_fetch_array($s);
												echo $srn['screen_name'];
								...
								?>
									...
									<tr>
										...
										<td id="amount" style="font-weight:bold;font-size:18px">
											kes <?php echo $srn['charge'];?>
										</td>
									</tr>
									<tr>
										<td colspan="2"><?php if($avl[0]==$srn['seats']){?><button type="button" class="btn btn-danger" style="width:100%">House Full</button><?php } else { ?>
